...
sys.path.append('..')
sys.path.append('../..')
from dove.settings import BASE_DIR
...
# os.path.join(str(os.path.abspath(__file__).split("dove")), 'dove', 'media', 'book', 'img')
...
if __name__ == "__main__":
    print(os.path.join(str(os.path.abspath(__file__).split('dove')[0]), 'dove', 'media', 'book', 'img'))
    print(IMAGES_STORE)
